...
#SBATCH --output=../DA_ENCORE_RETOUCH_MICCAI23_Results/code_outputs/Supervised_DA_%j.out_
#SBATCH --error=../DA_ENCORE_RETOUCH_MICCAI23_Results/code_errors/Supervised_DA_%j.err
...
srun /storage/homefs/ng22l920/anaconda3/envs/PyTorch_RTX3090/bin/python3 Just_Supervised.py --config 'configs_RETOUCH_DA_scSENet_ST4.Config_Supervised'