...
#SBATCH --output=../DA_ENCORE_RETOUCH_MICCAI23_Results/code_outputs/ENCORE_AugLoss_UnsupOnTrain_%j.out_
#SBATCH --error=../DA_ENCORE_RETOUCH_MICCAI23_Results/code_errors/ENCORE_AugLoss_UnsupOnTrain_%j.err
...
srun /storage/homefs/ng22l920/anaconda3/envs/PyTorch_RTX3090/bin/python3 ENCORE_AugLoss.py --config 'configs_RETOUCH_DA_scSENet_ST4.Config_ENCORE_AugLoss_UnsupOnTrain_T85'