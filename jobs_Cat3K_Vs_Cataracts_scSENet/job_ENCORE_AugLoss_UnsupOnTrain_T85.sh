...
# Runtime and memory
#SBATCH --time=5-24:00:00    # days-HH:MM:SS
...
srun --output ../DA_ENCORE_MICCAI23_Results/code_outputs/ENCORE_AugLoss_UnsupOnTrain_%j.out_ --error ../DA_ENCORE_MICCAI23_Results/code_errors/ENCORE_AugLoss_UnsupOnTrain_%j.err /storage/homefs/ng22l920/anaconda3/envs/PyTorch_RTX3090/bin/python3 ENCORE_AugLoss.py --config 'configs_Cat3k_Vs_Cataracts_scSENet.Config_ENCORE_AugLoss_UnsupOnTrain_T85'