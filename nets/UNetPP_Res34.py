...
from .unet_parts import * # Remove . if you want to run this script separately.
                          # Otherwise, you will ger the ImportError: attempted relative import with no known parent package
...
class UNetPP_Res34(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=True):
        super(UNetPP_Res34, self).__init__()
...
if __name__ == '__main__':
    ...
    model = UNetPP_Res34(n_channels=3, n_classes=1, bilinear=False)
