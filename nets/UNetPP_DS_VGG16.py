...
class UNetPP_DS_VGG16(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=True):
        super(UNetPP_DS_VGG16, self).__init__()
        ...
        self.outc_XL = OutConv(32, n_classes)
        self.outc_L = OutConv(32, n_classes)
        self.outc_S = OutConv(32, n_classes)
        self.outc_XS = OutConv(32, n_classes)
...
if __name__ == '__main__':
    ...
    model = UNetPP_DS_VGG16(n_channels=3, n_classes=1, bilinear=False)
