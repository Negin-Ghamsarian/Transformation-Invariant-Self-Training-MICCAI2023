...
class Up(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, input_size):
        ...
        self.se = ChannelSpatialSELayer(out_channels*4, input_size)
...
class AdaptNet_ReCal_V2_VGG16(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=True):
        super(AdaptNet_ReCal_V2_VGG16, self).__init__()
...
if __name__ == '__main__':
    model = AdaptNet_ReCal_V2_VGG16(n_channels=3, n_classes=1)
