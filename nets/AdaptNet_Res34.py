...
class AdaptNet_Res34(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=True):
        super(AdaptNet_Res34, self).__init__()
        ...
        self.glob1 = Cascade_Pooling(input_channels=512, input_size=16)

        self.up1 = Up(512+256, 128, 32)
        self.up2 = Up(256, 64, 64)
        self.up3 = Up(128, 64, 128)
        self.up4 = Up(128, 32, 256)
...
if __name__ == '__main__':
    model = AdaptNet_Res34(n_channels=3, n_classes=1)
