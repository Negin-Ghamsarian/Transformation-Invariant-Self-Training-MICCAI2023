...
class PPM(nn.Module):
    def __init__(self, in_channels, out_channels, PPM_size = 12):
        super().__init__()
        ...
        self.pool1 = PoolUp(in_channels, s1, s1, out_channels, s1)
        self.pool2 = PoolUp(in_channels, s2, s2, out_channels, s2)
        self.pool3 = PoolUp(in_channels, s3, s3, out_channels, s3)
        self.pool4 = PoolUp(in_channels, s4, s4, out_channels, s4)
...
class UPerNet_decoder(nn.Module):
    def __init__(self, classes = 11, in_channels=2048, PPM_size = 12):
        super(UPerNet_decoder, self).__init__()


        self.pp = PPM(2048, 256, PPM_size = PPM_size)
...
class UPerNet_Org_Res50(nn.Module):
      def __init__(self, classes = 11, in_channels=3, PPM_size = 12):
          super(UPerNet_Org_Res50, self).__init__()
          ...
          self.decoder = UPerNet_decoder(classes = classes, PPM_size = PPM_size)
