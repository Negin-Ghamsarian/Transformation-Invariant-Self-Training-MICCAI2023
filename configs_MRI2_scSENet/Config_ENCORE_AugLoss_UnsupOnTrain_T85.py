...
Categories = ['BMCVsBIDMC4_0','BMCVsBIDMC4_1','BMCVsBIDMC4_2','BMCVsBIDMC4_3']
Learning_Rates_init = [0.001]
epochs = 100
batch_size = 4
size = (384, 384)

Dataset_Path_Train = '/storage/homefs/ng22l920/Codes/Semi_Supervised_ENCORE/Semi_Supervised_ENCORE_MICCAI23/TrainIDs_MRI_DA/'
Dataset_Path_SemiTrain = ''
Dataset_Path_Test = ''

mask_folder = ''
Results_path = '../DA_MRI_MICCAI23_Results/'
Visualization_path = 'visualization/'
Checkpoint_path = 'checkpoints/'
CSV_path = 'CSVs/'
project_name = "ENCORE_MRI2_MIC23"
